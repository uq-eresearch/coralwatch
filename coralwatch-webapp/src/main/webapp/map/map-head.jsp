...
<script language="javascript" type="text/javascript" src="../js/timeline-api.js"></script>
<script language="javascript" type="text/javascript" src="../js/timemap_full.pack.js"></script>
