...
<div id="newkitrequest" dojoType="dijit.layout.ContentPane" title="New Chart Request" style="width:670px; height:130ex">
    ...
    <form dojoType="dijit.form.Form" action="<portlet:actionURL/>" method="post" name="<portlet:namespace />fm"
        ...
        <table>
            ...
            <tr>
                <th></th>
                <td><span style="color:#FF0000">*</span> You can download the Do It Yourself Kit from <a href="javascript: (getCookie('datamodule') ? postToParent({action: 'routeTo', data: 'monitoring/'}) : window.location.href = window.location.origin + '/web/guest/monitoring-products');">here</a> and request the chart only
