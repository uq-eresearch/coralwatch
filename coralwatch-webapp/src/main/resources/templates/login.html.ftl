            ...
            <tr>
                ...
                <td>
                    <input type="text"
                           ...
                           trim="true"
                           invalidMessage="Enter a valid email address e.g. address@organisation.com."/>
                </td>
            </tr>
            <tr>
                <td class="headercell">
            ...
            <tr>
                <td class="headercell">
                    <button dojoType="dijit.form.Button" type="submit"
                            name="login" value="Login" id="loginButton">Login
                    </button>
                </td>
                <td>
...
<tr>
    ...
    <td>
        <input type="text"
               ...
               dojoType="dijit.form.ValidationTextBox"
               regExp=".......*"
               invalidMessage="Please enter a display name with at least 6 characters"/> <em>e.g. John Smith</em>
    </td>
</tr>
<tr>
<td class="headercell">
...
<tr>
    <td colspan="2" class="headercell">
        <button dojoType="dijit.form.Button" type="submit"
                ...
                id="createButton">Create Account
        </button>
    </td>
</tr>
</table>
...
<div id="tabSubmitData" dojoType="dijit.layout.ContentPane" title="Submit Data">
    <div dojoType="dijit.form.Form" method="post" action="oneoff" style="padding:5px;">
        ...
        <table>
            <tr>
                <td class="headercell">
                    <label for="emailDataOnly">Email:</label>
                </td>
                <td>
                    <input type="text"
                           id="emailDataOnly"
            ...
            <tr>
                <td colspan="2" class="headercell">
                    <button dojoType="dijit.form.Button" type="submit"
                            name="noAccount" value="No Account"
                            id="submitDataButton">Submit Survey
                    </button>
                </td>
            </tr>
        </table>
