...
(function($) {
        ...
        tagcloud: function(_settings) {
            ...
            return this.each(function(i, o) {
                ...
                for (var j = 0; j < iNumLi; j++) {
                    ...
                    var rating = parseInt(mLi.attr("rating"));
                    if (rating < 0) {
                        rating = 0;
                    }
                    var iSzFnt = ((rating) * 4) + 6;
                    ...
                    mLi.css({"fontSize":iSzFnt,position:"absolute",color:"#" + sColor,margin:0,padding:0});
                    var iLiW = mLi.width();
                    var iLiH = mLi.height()
                    //
                    var oCss = {};
                    ...
                    $(mLi).qtip(
                    {
                        content: '<img src="' + $(mLi).attr('rel') + '" />'/* + getStars(rating)*/,
                        position: {
                            corner: {
                        ...
                        //                            $("#userRating").children().not(":input").hide();
    ...
    //        var stars = '<div class="rator" id="userRating">';
    //        if (rating >= 0 && rating < 1.5) {
    //            stars = stars + '<input type="radio" name="ratingValue" value="1" type="radio" checked="checked">';
    //        } else {
    //            stars = stars + '<input type="radio" name="ratingValue" value="1" type="radio">';
    //        }
    //        if (rating >= 1.5 && rating < 2.5) {
    //            stars = stars + '<input type="radio" name="ratingValue" value="2" type="radio" checked="checked">';
    //        } else {
    //            stars = stars + '<input type="radio" name="ratingValue" value="2" type="radio">';
    //        }
    //        if (rating >= 2.5 && rating < 3.5) {
    //            stars = stars + '<input type="radio" name="ratingValue" value="3" type="radio" checked="checked">';
    //        } else {
    //            stars = stars + '<input type="radio" name="ratingValue" value="3" type="radio">';
    //        }
    //        if (rating >= 3.5 && rating < 4.5) {
    //            stars = stars + '<input type="radio" name="ratingValue" value="4" type="radio" checked="checked">';
    //        } else {
    //            stars = stars + '<input type="radio" name="ratingValue" value="4" type="radio">';
    //        }
    //        if (rating >= 4.5 && rating <= 5) {
    //            stars = stars + '<input type="radio" name="ratingValue" value="5" type="radio" checked="checked"></div>';
    //        } else {
    //            stars = stars + '<input type="radio" name="ratingValue" value="5" type="radio"></div>';
    //        }
    //
    //        return stars;
    //    }
