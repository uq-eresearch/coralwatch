...
sudo chown -R root:root $CORALWATCH_DIR/coralwatch-theme/docroot/_diffs
sudo ls -la $CORALWATCH_DIR/coralwatch-theme/docroot/_diffs
sudo tar -zcvf $DOCKER_DIR/coralwatch-theme_diffs.tar.gz $CORALWATCH_DIR/coralwatch-theme/docroot/_diffs
sudo ls -ka $DOCKER_DIR
